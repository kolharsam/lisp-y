...
function gt() {
    ...
    if (argsCount < 2) {
        throwArgsError("gt", argsCount, args);
        return;
    }
...
function lt() {
    ...
    if (argsCount < 2) {
        throwArgsError("lt", argsCount, args);
        return;
    }
...
function gtEq() {
    ...
    if (argsCount < 2) {
        throwArgsError("gtEq", argsCount, args);
        return;
    }
...
function ltEq() {
    ...
    if (argsCount < 2) {
        throwArgsError("ltEq", argsCount, args);
        return;
    }
...
function set() {
    ...
    // TODO: show the first duplicate key as part of the error
    ...
    if (!Array.isArray(setContent)) {
        throwError({
            func: "set",
            message: "Argument(s) are not a function",
        });
        return;
    }
    ...
    if (distinctElems.length !== setContent.length) {
        throwError({
            func: "set",
            message: "There are duplicate keys present",
        });
        return;
    }
